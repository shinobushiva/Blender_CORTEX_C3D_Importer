...
class Parameter:
    def __init__(self, infile):
        ...
        #This is a quick fix for a file exported from Cortex (Motion Analysis)
        #Cortex: http://www.motionanalysis.com/html/industrial/cortex.html
        if offset < 3:
            offset = 3
...
class MarkerSet:
    ...
    def readHeader(self, infile, scale):
        (self.firstParameterBlock, key, self.markerCount, self.analogChannelCount,
        ...
        (self.scale, self.dataBlock, self.analogSampleCount,
    ...
    def readFrameData(self, infile):
        ...
        for f in range(self.startFrame, self.endFrame + 1):
            ...
            #skip analog data storage
            infile.read(self.analogChannelCount * self.analogSampleCount * 4)
    ...
    def readNextFrameData(self):
        if len(self.frames) < (self.endFrame - self.startFrame + 1):
            ...
            #skip analog data storage
            self.infile.read(self.analogChannelCount * self.analogSampleCount * 4)
